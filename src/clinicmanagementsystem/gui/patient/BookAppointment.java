...
public class BookAppointment extends javax.swing.JDialog {
     ...
     */
    public BookAppointment(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Time (e.g. 10:00):");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                BookAppointment dialog = new BookAppointment(new javax.swing.JFrame(), true);
